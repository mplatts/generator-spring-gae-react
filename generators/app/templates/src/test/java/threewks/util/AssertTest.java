...
public class AssertTest {
    ...
    public void isPresent() {
        Assert.isPresent(Optional.of("present"), "Bla");
    }

    @Test
    public void isPresent_WilError_whenEmptyOptional() {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("exterminate!");

        Assert.isPresent(Optional.empty(), "exterminate!");
    }

    @Test
    public void isAbsent() {
        Assert.isAbsent(Optional.empty(), "Bla");
    }

    @Test
    public void isAbsent_WilError_whenOptionalHasValue() {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("exterminate!");

        Assert.isAbsent(Optional.of("present"), "exterminate!");
    }
